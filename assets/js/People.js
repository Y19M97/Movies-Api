...
let res= await fetch(`https://api.themoviedb.org/3/trending/person/day?api_key=d903bcdae97d41411a8e54f49fb3b5d0`)
    ...
    for( let i=0 ; i<Api.length; i++){
        ...
        <div class="movie position-relative shadow-lg rounded mt-5">
            <div class="rate position-absolute end-0">
                <span>${Api[i].popularity}M</span>
            </div>
            <img class=" card-img-top w-100" src="https://image.tmdb.org/t/p/w500/${Api[i].profile_path}" alt="">
